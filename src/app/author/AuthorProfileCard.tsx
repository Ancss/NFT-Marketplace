      ...
      <div className={cn('mx-auto w-4/5tt grid grid-cols-1 justify-self-center items-center bg-main-bg p-2 rounded-lg shadow-custom gap-12', 'lg:w-11/12tt lg:grid-cols-[1fr_4fr_1.3fr] lg:p-10 lg:gap-4', 'md:grid-cols-[1fr_2fr] md:gap-4')}>
        ...
        <div className={cn('ml-6')}>
          ...
          <div className={cn('flex items-center gap-4 text-2xl mt-4 ')}>
            <a href="#" className={cn('bg-icons text-main-bg rounded-full grid p-2 border-[1px] border-icons', 'transition-all duration-300 ease-in cursor-pointer', 'hover:shadow-custom hover:bg-main-bg hover:border-icons hover:text-icons')}>
              <TiSocialFacebook />
            </a>
            <a href="#" className={cn('bg-icons text-main-bg rounded-full grid p-2 border-[1px] border-icons', 'transition-all duration-300 ease-in cursor-pointer', 'hover:shadow-custom hover:bg-main-bg hover:border-icons hover:text-icons')}>
              <TiSocialInstagram />
        ...
        <div className={cn('flex justify-around items-center gap-8')}>
          ...
          <DropdownMenu >
            ...
            <DropdownMenuContent className=" bg-main-bg border border-primary">
              ...
              <DropdownMenuItem>
                <p className={cn('flex items-center gap-4 cursor-pointer transition-all duration-300 ease-in p-[0.3rem_0.5rem] rounded-sm', 'hover:bg-icons hover:text-main-bg')}>
          ...
          <DropdownMenu >
            <DropdownMenuTrigger className="" >
              <BsThreeDots onClick={openReport} className={cn('text-4xl cursor-pointer')} />
            </DropdownMenuTrigger >
            <DropdownMenuContent className=" bg-main-bg border border-primary">
              {/* <DropdownMenuLabel className="mt-4">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem>
                <p className={cn('flex items-center gap-8  px-4 py-2 cursor-pointer hover:bg-icons hover:text-main-bg')}>
